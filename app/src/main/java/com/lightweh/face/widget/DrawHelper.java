package com.lightweh.face.widget;
...
public class DrawHelper {
    ...
    private static FaceRectView mFaceRectView;
...
//        }
    ...
    public static void drawFaceRect(Canvas canvas, DrawInfo drawInfo, int color, int faceRectThickness) {
        ...
        Path mPath = new Path();
        int winHeight = mFaceRectView.getHeight();
        int winWidth = mFaceRectView.getWidth();

//        int imageHeight = GlobalFlag.getInstance().imageHeight;
//        int imageWidth = GlobalFlag.getInstance().imageWidth;
        RectF rect = null;
//        if (GlobalFlag.getInstance().camera_orientation == Camera.CameraInfo.CAMERA_FACING_BACK) {
//            // 后摄像头
//            rect = new RectF(drawInfo.left, drawInfo.top, drawInfo.w, drawInfo.h);
//        } else {
//            // 前摄像头
//            int top = (int) (drawInfo.top * winHeight / imageHeight + 0.5);
//            int bottom = (int) (drawInfo.h * winHeight / imageHeight + 0.5);
//            int left = winWidth - (int) (drawInfo.left * winWidth / imageWidth + 0.5);
//            int right = winWidth - (int) (drawInfo.w * winWidth / imageWidth + 0.5);
//            rect = new RectF(right, top, left, bottom);
//        }
        rect = new RectF(drawInfo.left, drawInfo.top, drawInfo.w, drawInfo.h);
        /**
         * 后摄像头
